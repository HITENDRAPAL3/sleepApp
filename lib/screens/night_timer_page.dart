...
class NightTimerPage extends StatefulWidget {
  const NightTimerPage({super.key});

  @override
  State<NightTimerPage> createState() => _NightTimerPageState();
}

class _NightTimerPageState extends State<NightTimerPage> with TickerProviderStateMixin {
  ...
  Future<void> _loadData() async {
    try {
      ...
      final existingTimer = await PreferencesService.getNightTimer();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Night Sleep Timer'),
        leading: IconButton(
                ...
                FadeTransition(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Choose when you want to go to sleep and pick a soothing tone to remind you.',
